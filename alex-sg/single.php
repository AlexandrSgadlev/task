...
<div id="primary" class="content-area">
	<div class="container">
			...
			<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				...
				<div class="left-i">
					<div class="top-i">
						...
						<?php do_action( 'img-immovable'); ?>
						
						<div class="img-i">
							<?php
								if($fields['Images']){
									echo '<img src="' . $fields['Images']['url'] . '" class="wp-post-image" alt="Image ' . get_the_title() . '" title="Image ' . get_the_title() . '" draggable="false" />';
								}
							?>
						</div>
					</div>
				...
				<div class="right-i">
					<div class="the-unique-id-i">
						<p class="unique-id-i">
							<?php
								if($fields['Property_Ref_No']){
									_e( 'Unit Reference: ', THEME_NAME );
									echo $fields['Property_Ref_No'];
								}
							?>
						</p>
					</div>	
				...
				<div class="bottom-i">
					...
					<div class="project-details-i">
						<h2><?php _e( 'Project Details', THEME_NAME ); ?></h2>
						<table class="project-details-list">
							<?php if($fields['Property_Ref_No']): ?>
							<tr>
								<td class="label"><?php _e( 'Unit Referenc', THEME_NAME ); ?></td>
								<td class="value"><?php echo $fields['Property_Ref_No']; ?></td>
							</tr>
							<?php endif; ?>
							<?php if($fields['Parking_Slots']): ?>
							<tr>
								<td class="label"><?php _e( 'Parking Slots', THEME_NAME ); ?></td>
								<td class="value"><?php echo $fields['Parking_Slots']; ?></td>
							</tr>
							<?php endif; ?>
							<?php if($fields['Property_Name']): ?>
							<tr>
								<td class="label"><?php _e( 'Property Name', THEME_NAME ); ?></td>
								<td class="value"><?php echo $fields['Property_Name']; ?></td>
							</tr>
							<?php endif; ?>
							<tr>
								<td class="label"><?php _e( 'Permit Number', THEME_NAME ); ?></td>
								<td class="value">71383570558</td>
							</tr>
							<?php if($fields['Listing_Date']): ?>
							<tr>
								<td class="label"><?php _e( 'Addeed on', THEME_NAME ); ?></td>
								<td class="value"><?php echo $fields['Listing_Date']; ?></td>
							</tr>
							<?php endif; ?>
						</table>
					</div>
				...
				<div class="entry-content">
					...
					the_content( sprintf(
						wp_kses(
							...
							__( 'Continue reading<span class="screen-reader-text"> "%s"</span>', 'alex-sg' ),
							array(
								'span' => array(
									'class' => array(),
								),
					...
					wp_link_pages( array(
						'before' => '<div class="page-links">' . esc_html__( 'Pages:', 'alex-sg' ),
						'after'  => '</div>',
					) );
					?>
				</div><!-- .entry-content -->
		...
		<?php do_action('before_footer_immovable'); ?>
